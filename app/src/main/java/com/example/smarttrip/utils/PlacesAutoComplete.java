...
import com.example.smarttrip.model.PlaceAPI;

import java.util.ArrayList;

public class PlacesAutoComplete extends ArrayAdapter implements Filterable {
    ...
    public PlacesAutoComplete(Context context, int resultId){
